...
%Al posto della varianza viene usato il change rate di pressione
                    ...
                    case 'Possibile Caduta'
                        ...
                        if any(acc(i:peak_window_end) >= peak_threshold)
                            ...
                            if ~isempty(valley_indices)
                                ...
                                RMS_ACC = rms(acc(postTransition_start_index :postTransition_end_index)) 
