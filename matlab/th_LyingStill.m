...
% Magnitude" relativi ai test "Lying Still", in cui il soggetto rimane
% fermo mentre è sdraiato dopo una caduta.
...
% Ciclo per caricare per caduta LyingStill
for i = 1:30
    % Nome del file CSV
...
% 1. Linea retta: I punti nel grafico seguono abbastanza bene una linea
% retta, specialmente nella parte centrale. Questo suggerisce che i dati
% sono approssimativamente normali nella parte centrale della
% distribuzione.

% 2. Deviazioni alle estremità: Notiamo che ci sono alcune deviazioni dalla
% linea retta alle estremità. Questo potrebbe indicare che i dati hanno
% code più pesanti o più leggere rispetto a una distribuzione normale,
% quindi la presenza di valori estremi (o outliers).

% figure; h = qqplot(max_peak_vec); set(h, 'Marker', 'o', 'MarkerSize', 8,
...
% figure; h = qqplot(min_valley_vec); set(h, 'Marker', 'o', 'MarkerSize',
% 8, 'MarkerEdgeColor', 'k', 'MarkerFaceColor', 'b');
...
x = linspace(0.98, 1.05, 100); % Intervallo dei valori su cui calcolare la gaussiana
...
% Creazione della seconda figura con la distribuzione gaussiana
x = linspace(0.93, 1.02, 100); % Intervallo dei valori su cui calcolare la gaussiana
